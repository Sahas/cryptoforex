...
public final class CryptoForexConsts {
  ...
  public static final String EXCHNAGES_INFO_PATH =
      RESOURCES_HOME + "static/exchanges/ExchangesInfo.xml";
  public static final String EXCHNAGES_API_DEF_FOLDER = RESOURCES_HOME + "static/apiStrategies/";
